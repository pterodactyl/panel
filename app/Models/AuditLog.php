...
class AuditLog extends Model
{
    ...
    public const SERVER__FILESYSTEM_DOWNLOAD = 'Download';
    public const SERVER__FILESYSTEM_WRITE = 'Write';
    public const SERVER__FILESYSTEM_DELETE = 'Delete';
    public const SERVER__FILESYSTEM_RENAME = 'Rename';
    public const SERVER__FILESYSTEM_COMPRESS = 'Compress';
    public const SERVER__FILESYSTEM_DECOMPRESS = 'Decompress';
    public const SERVER__FILESYSTEM_PULL = 'Pull';
    public const SERVER__BACKUP_STARTED = 'Start Backup';
