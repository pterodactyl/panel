...
return [
    ...
    'database' => [
        ...
        'content' => [
            ...
            'conn' => 'Connections',
            'conn_hint' => 'This should reflect the IP address that connections are allowed from. Uses standard MySQL notation. If unsure leave as <code>%</code>.',
            'auth_hint' => 'A username and password for this database will be randomly generated after form submission.',
