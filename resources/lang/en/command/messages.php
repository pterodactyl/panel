...
return [
    ...
    'node' => [
        ...
        'ask_scheme' => 'Which scheme should be used? (Enable SSL=https / Disable SSL=http)',
        ...
        'ask_maintenance_mode' => 'Should maintenance mode be enabled? (Enable Maintenance mode=1 / Disable Maintenance mode=0)',
        'ask_memory' => 'Enter the maximum memory amount',
        'ask_memory_overallocate' => 'Enter the amount of ram to overallocate (% or -1 to overallocate the maximum)',
        'ask_disk' => 'Enter the maximum disk amount',
        'ask_disk_overallocate' => 'Enter the amount of disk to overallocate (% or -1 to overallocate the maximum)',
