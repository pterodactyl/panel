...
return [
    ...
    'node' => [
        'ask_name' => 'Node name',
        'ask_description' => 'Node description',
        'ask_location_id' => 'Location id',
        'ask_fqdn' => 'FQDN',
        'ask_scheme' => 'Scheme',
        'ask_behind_proxy' => 'Behind proxy',
        'ask_daemonBase' => 'Daemon base',
        'ask_memory' => 'Memory',
        'ask_memory_overallocate' => 'Memory overallocate',
        'ask_disk' => 'Disk',
        'ask_disk_overallocate' => 'Disk overallocate',
