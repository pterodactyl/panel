                            ...
                            @foreach($resources as $resource)
                                <tr>
                                    ...
                                    <td class="col-sm-3 radio text-center">
                                        ...
                                        <label for="n_{{ $resource }}">禁止使用</label>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">一旦您分配了权限并创建了这组凭据，您将无法返回并编辑它。 如果您需要进行更改，则需要创建一组新凭据。</p>
                    </div>
