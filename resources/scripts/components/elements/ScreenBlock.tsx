...
const ScreenBlock = ({ title, image, message, onBack, onRetry }: ScreenBlockProps) => (
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            <div
                // css={tw`w-full sm:w-3/4 md:w-1/2 p-12 md:p-20 bg-neutral-900 bg-opacity-0 rounded-lg shadow-lg text-center relative`}
                css={tw`w-full sm:w-3/4 md:w-1/2 p-12 md:p-20 bg-neutral-900 bg-opacity-0 rounded-lg text-center relative`}
            >
