...
export default ({ server, className }: { server: Server; className?: string }) => {
    ...
    const diskLimit = server.limits.disk !== 0 ? megabytesToHuman(server.limits.disk) : '无限制';
    const memoryLimit = server.limits.memory !== 0 ? megabytesToHuman(server.limits.memory) : '无限制';
