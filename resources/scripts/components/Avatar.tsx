...
const _Avatar = ({ email, name, size = 48, alt, className, style, ...props }: Props) => {
    ...
    return <img src={src} width={size} height={size} className={className} style={style} alt={alt ?? 'Avatar'} {...props} />;
};
...
const _UserAvatar = ({ size = 48, alt, className, style, ...props }: Omit<Props, 'name'>) => {
    ...
    return <img src={src} width={size} height={size} className={className} style={style} alt={alt ?? 'User avatar'} {...props} />;
};
