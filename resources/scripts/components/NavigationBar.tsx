...
import { faBars, faCogs, faLayerGroup, faSignOutAlt, faUserCircle, faShoppingCart } from '@fortawesome/free-solid-svg-icons';
...
export default () => {
    ...
    return (
        <div className={'bg-neutral-700 shadow-md overflow-x-hidden topbar'}>
