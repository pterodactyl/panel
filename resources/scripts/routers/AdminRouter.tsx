    ...
    return (
        <div css={tw`h-screen w-screen overflow-x-hidden flex flex-col md:flex-row`}>
            <Sidebar collapsed={collapsed}>
                ...
                <NavLink to={'/'} css={tw`h-8 w-8 flex items-center justify-center text-neutral-300 hover:text-primary-400 hover:bg-neutral-800 rounded mt-auto mb-3 transition-all duration-100`}>
