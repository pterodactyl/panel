...
function addDataPoint(pointNumber, prefix) {
  return '<br>' + Functions.sprintf(Messages.strPointN, pointNumber + 1) + ': ' + '<label>' + Messages.strX + ' <input type="text" name="' + prefix + '[' + pointNumber + '][x]" value="">' + '</label>' + ' <label>' + Messages.strY + ' <input type="text" name="' + prefix + '[' + pointNumber + '][y]" value="">' + '</label> ';
}
...
function openGISEditor() {
  ...
  $('#gis_editor').append('<div id="gis_data_editor">' + '<img class="ajaxIcon" id="loadingMonitorIcon" src="' + themeImagePath + 'ajax_clock_small.gif" alt="">' + '</div>').fadeIn('fast');
}
...
AJAX.registerOnload('gis_data_editor.js', function () {
  ...
  $(document).on('click', '#gis_editor a.addJs.addLine', function () {
    ...
    html += '<a class="btn btn-secondary addPoint addJs" name="' + prefix + '[' + noOfLines + '][add_point]" href="#">+ ' + Messages.strAddPoint + '</a><br>';
    $a.before(html);
  ...
  $(document).on('click', '#gis_editor a.addJs.addPolygon', function () {
    ...
    html += '<a class="btn btn-secondary addPoint addJs" name="' + prefix + '[' + noOfPolygons + '][0][add_point]" href="#">+ ' + Messages.strAddPoint + '</a><br>' + '<a class="btn btn-secondary addLine addJs" name="' + prefix + '[' + noOfPolygons + '][add_line]" href="#">+ ' + Messages.strAddInnerRing + '</a><br><br>';
    $a.before(html);
  ...
  $(document).on('click', '#gis_editor a.addJs.addGeom', function () {
    ...
    var html2 = '<br>' + Messages.strPoint + ': ' + '<label>' + Messages.strX + ' <input type="text" name="gis_data[' + noOfGeoms + '][POINT][x]" value="">' + '</label>' + ' <label>' + Messages.strY + ' <input type="text" name="gis_data[' + noOfGeoms + '][POINT][y]" value="">' + '</label>' + '<br><br>';
